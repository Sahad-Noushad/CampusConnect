    ...
    <head>
        ...
        <script>
            ...
            function upvote(idno,regno,op){
                $.post("../../query/cpost.php",{id:idno,regno:regno,op:op},function(){
                    location.reload();
                });
            }
        </script>
        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <div class="qpost" id="qpost">
                    <form action="../../query/cmntadd.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="center">
                            <p>
                                <?php 
                                    echo $row['content'];
                                    if($row['img']!='NULL'){
                                        echo "<br><a href=\"../../query/images/".$row['img']."\"><img src=\"../../query/images/".$row['img']."\" style=\"width:400px;\"></a>";
                                    }
                                ?>
                            </p>
                        </div>
                        ...
                        <div class="center">
                            <p>
                                <?php 
                                    echo $rows['content'];
                                    if($rows['img']!='NULL'){
                                        echo "<br><a href=\"../../query/images/".$rows['img']."\"><../../query/img src=\"images/".$rows['img']."\" style=\"width:400px;\"></a>";
                                    }
                                ?>
                            </p>
                        </div>
