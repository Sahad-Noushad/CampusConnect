<?php
    ...
    if(isset($_SESSION['idno'])){
        ...
        $sql="SELECT * FROM query ORDER BY vote DESC";
    ...
    <head>
        ...
        <script>
            ...
            function upvote(idno,regno,op){
                $.post("post.php",{id:idno,regno:regno,op:op},function(){
                    location.reload();
                });
            }
        </script>
        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <div class="qpost" id="qpost">
                    <form action="qpost.php" method="post" enctype="multipart/form-data">
                        <span class="subject">
                            ...
                            <p>
                                <?php 
                                    ...
                                    if($row['img']!='NULL'){
                                        ...
                                        if($ext=="pdf"){
                                            echo "<br><br><embed src=\"images/".$row['img']."\" width=\"500px\" height=\"400px\"><br><br><a href=\"images/".$row['img']."\" style=\"text-decoration:none;color:white;\">Open Pdf</a>";
                                        }
                                        else{
                                            echo "<br><br><a href=\"images/".$row['img']."\"><img src=\"images/".$row['img']."\" width=\"400px\"></a>";
                                        }
