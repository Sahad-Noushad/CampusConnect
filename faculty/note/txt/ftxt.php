...
<html>
    ...
    <body>
        <div class="back">
            ...
            <div class="content">
                <div class="delete" onclick="location.href='delete/ftxtdel.php'">
                    <p>TextBook deletion <i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="upload" onclick="location.href='upload/ftxtadd.php'">
                    <p>TextBook uploading<i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="list" onclick="location.href='list/ftxtlist.php'">
