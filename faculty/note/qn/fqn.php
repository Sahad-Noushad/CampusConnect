...
<html>
    ...
    <body>
        <div class="back">
            ...
            <div class="content">
                <div class="delete" onclick="location.href='delete/fqndel.php'">
                    <p>Qn deletion <i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="upload" onclick="location.href='upload/fqnadd.php'">
                    <p>Qn uploading<i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="list" onclick="location.href='list/fqnlist.php'">
