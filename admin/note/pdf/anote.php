...
<html>
    ...
    <body>
        <div class="back">
            ...
            <div class="content">
                <div class="ver" onclick="location.href='verify/anotever.php'">
                    <p>Note verification <i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="delete" onclick="location.href='delete/anotedel.php'">
                    <p>Note deletion <i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="atten" onclick="location.href='upload/anoteadd.php'">
                    <p>Note uploading<i class="fas fa-arrow-circle-right"></i></p>
                </div>
                <div class="list" onclick="location.href='list/anotelist.php'">
