...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function delet(file){
                $.post("atxtdel1.php",{file:file},function(data){
                    if(data==1){
                        alert("Deleted");
            ...
            function note(sub){
                ...
                $.post("txtdel.php",{sub:sub,course:course,year:year,sem:sem,sub:sub},function(data){
                    $("#note").html(data);
                });
            }
        </script>
    ...
    <body>
        <div class="back">
            <div class="nav">
                <ul>
                    <li><a href="../atxt.php"><i class="fas fa-arrow-circle-left"></i>Back</a></li>
                </ul>
                <p>Text Book Deletion</p>
                <ul>
                    <li>
